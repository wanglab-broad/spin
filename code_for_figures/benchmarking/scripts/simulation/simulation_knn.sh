...
#$ -l h_vmem=8G
#$ -l h_rt=00:30:00
#$ -o /stanley/WangLab/kamal/outputs/spin/reviews/simulation/knn/
#$ -j y
#$ -t 1-110
...
--n_pcs 50 \
--leiden_res "0.2" \
--write_path /stanley/WangLab/kamal/data/projects/spin/reviews/results/simulation/knn/reconstructions_${sample_rate}_${k_physical}physical_${k_latent}latent/ \
