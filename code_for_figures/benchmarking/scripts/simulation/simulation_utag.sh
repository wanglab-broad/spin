...
#$ -l h_vmem=16G
#$ -l h_rt=00:10:00
#$ -o /stanley/WangLab/kamal/outputs/spin/reviews/simulation/utag/
#$ -j y
#$ -t 1-110
...
--n_pcs 50 \
--leiden_res "0.2" \
--write_path /stanley/WangLab/kamal/data/projects/spin/reviews/results/simulation/utag/reconstructions_${sample_rate}_${radius}radius_${k_latent}latent/ \
