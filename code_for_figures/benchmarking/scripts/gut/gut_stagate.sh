...
#$ -l h_vmem=120G
#$ -l h_rt=05:00:00
#$ -o /stanley/WangLab/kamal/outputs/spin/reviews/gut/stagate/
#$ -j y
#$ -t 1-110
...
--k_latent $k_latent \
--leiden_res "0.2" \
--write_path /stanley/WangLab/kamal/data/projects/spin/reviews/results/gut/stagate/reconstructions_${sample_rate}_${k_physical}physical_${k_latent}latent/ \
