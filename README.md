...
```
This dataset contains expression and spatial data from marmoset and mouse brain, corresponding to the labels `marmoset` and `mouse` under the key `.obs['species']`.
